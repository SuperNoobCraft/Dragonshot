...
/// <summary>
/// World-space label: click / wand-trigger to cycle CAVE aim modes
/// (Bow Only / Free Shaft / Soft Coupled).
/// Create via BowController context menu → Create Aim Mode Config Label.
/// </summary>
[RequireComponent(typeof(Collider))]
public class AimModeConfigLabel : MonoBehaviour
{
    [Header("References")]
    ...
    private void RefreshLabel()
    {
        ...
        string mode = BowController.AimModeLabel(bow.AimMode);
        string hint = "click to cycle";
        if (bow.AimMode == BowAimMode.SoftCoupled)
        {
            hint = "blend " + bow.SoftCoupleBlend.ToString("0.00") + "\n" + hint;
        }
